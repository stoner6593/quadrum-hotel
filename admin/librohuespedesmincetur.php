...
<head>
<meta charset="utf-8">
<title>Libro de Huéspedes mincetur</title>
            ...
            <td height="30" colspan="2"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                ...
                <tr>
                  <td height="30" class=" text-success">
                    <h3 style="color:#E1583E;"> <i class="fa fa-book"></i> Libro de Huéspedes mincetur</h3>
              ...
              <tr>
                <td width="1%">
                  ...
                  <form action="librohuespedesmincetur.php" name="frmlistadocumentos" id="frmlistadocumentos" method="POST">
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="example" class=" table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>HORA INGRESO</th>
                                <th>DIA INGRESO</th>
                                <th>NOMBRES Y APELLIDOS HUESPED</th>
                                <!--<th>EDAD</th>-->
                                <th>SEXO</th>
                                <th>CLASE</th>
                                ...
                                <!--<th>LUGAR NACIMIENTO - CIUDAD</th>-->
                                <th>LUGAR NACIMIENTO - PAIS</th>
                                <!--<th>PROCEDENCIA</th>-->
                                <!--<th>DESTINO</th>-->
                                <th>HORA RETIRO</th>
                                <th>DIA RETIRO</th>
                                ...
                                <th>TIPO DOC</th>
                                <th>N° DOC. IDENTIDAD</th>
                                <th>SEXO ACOMPAÑANTE</th>
                                <th>NACIONALIDAD ACOMPAÑANTE</th>
                                <th>TARIFA</th>
                            </tr>
                        </thead>
                        <tbody>
...
<?php if(isset($_POST['finicio'])){ ?>
      ...
      table = $('#example').DataTable( {
        ...
        "aaSorting": [[ 2, 'asc' ]],
        "aoColumns": [
          { "sTitle": "CUARTO N°", mData: 'nrohabitacion'},
          { "sTitle": "HORA INGRESO", mData: 'hora_ingreso' },
          { "sTitle": "DIA INGRESO", mData: 'dia_ingreso'},
          { "sTitle": "NOMBRES Y APELLIDOS HUESPED", mData: 'nombre' },
          { "sTitle": "SEXO", mData: 'sexo' },
          //{ "sTitle": "EDAD", mData: 'edad' },
          { "sTitle": "TIPO DOC", mData: 'tipo_documento' },
          { "sTitle": "N° DOC. IDENTIDAD", mData: 'documento' },
          //{ "sTitle": "ESTADO CIVIL", mData: 'estadocivil_desc' },
          //{ "sTitle": "PROFESIÓN U OCUPACIÓN", mData: 'profesion' },
          //{ "sTitle": "LUGAR NACIMIENTO - CIUDAD", mData: 'ciudad' },
          { "sTitle": "LUGAR NACIMIENTO - PAIS", mData: 'pais' },
          //{ "sTitle": "PROCEDENCIA", mData: 'procedencia' },
          //{ "sTitle": "DESTINO", mData: 'destino' },
          { "sTitle": "HORA RETIRO", mData: 'hora_retiro' },
          { "sTitle": "DIA RETIRO", mData: 'dia_retiro' },
          { "sTitle": "MES RETIRO", mData: 'mes_retiro' },
          { "sTitle": "AÑO RETIRO", mData: 'anio_retiro' },
          { "sTitle": "ACOMPAÑANTE", mData: 'acompaniante' },
          { "sTitle": "TIPO DOC", mData: 'tipo_doc' },
          { "sTitle": "N° DOC. IDENTIDAD", mData: 'dni_acom' },
          { "sTitle": "SEXO ACOMPAÑANTE", mData: 'sexoAc' },
          { "sTitle": "NACIONALIDAD ACOMPAÑANTE", mData: 'nacionalidadAc' },
          { "sTitle": "TARIFA", mData: 'tot' },
         ],
         buttons: [
                    {
                        extend: 'print',
                        title: 'QUADRUMlibrohuespedesmincetur_<?php echo $finicio; ?>-<?php echo $ffin; ?>',
                        exportOptions: {
          ...
          "ajax": {
              "method": "POST",
              "url": "include/huesped/view_libro_huesped_mincetur.php",
              "data": function (d) {
                  return $.extend({}, d, {
