  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="810" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tbody>
          <tr>
            <td height="30" colspan="6"><h3 style="color:#E1583E;"> <i class="fa fa-users"></i> Control Mantenimiento </h3> </td>
            </tr>
          <tr>
          ...
          <tr>
            ...
            <div class="grupo">
            	...
            	<div class="caja tablet-20" style="background:#FFFFFF;">
                	<?php
                    	//Casos de Link
						if($xhFila['2']==4){ //Estado Mantenimiento
							$link = "registrarMantenimiento.php?idhabitacion=".$xhFila['0'].'&idalquiler='.$xidalquiler;
						}
					?>
                      ...
                      <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#<?php echo $xhFila['13'] ?>">
                        <tr>
                          <td width="39%" height="43" align="center" valign="middle" bgcolor="#FFFFFF">
                              <h2 style="color:#<?php echo $xhFila['13'] ?>; text-align:center; margin:0px;padding:0px;"> <?php echo $xhFila['4'] ?> </h2>
                              <span class="textoContenidoMenor" style="color:#<?php echo $xhFila['13'] ?>;">
                                      <?php echo habitacionIcono($xhFila['1']);?>
                              </span>
                          </td>
                          <td width="61%" align="center" valign="middle" bgcolor="#FFFFFF">
                              ...
                              <span class="textoContenidoMenor" style="color:#<?php echo $xhFila['13'] ?>; text-align:center; margin:0px;padding:0px;font-size:10px;">
                                  <?php echo $xhFila['10']; if($xhFila['16']==1){ echo "&nbsp; "."<i class='fa fa-th-large fa-lg'></i>";} ?>
                              </span>
                          </td>
                        </tr>
                        <tr>
