...
<head>
<meta charset="utf-8">
<title>Libro de Huéspedes</title>
            ...
            <td height="30" colspan="2"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                ...
                <tr>
                  <td height="30" class=" text-success">
                    <h3 style="color:#E1583E;"> <i class="fa fa-book"></i> Libro de Huéspedes</h3>
              ...
              <tr>
                <td width="1%">
                  ...
                  <form action="librohuespedes.php" name="frmlistadocumentos" id="frmlistadocumentos" method="POST">
      ...
      table = $('#example').DataTable( {
        ...
        "aoColumns": [
         ...
         buttons: [
          ...
          "ajax": {
              "method": "POST",
              "url": "include/huesped/view_libro_huesped.php",
              "data": function (d) {
                  return $.extend({}, d, {
