...
class Pdf extends TCPDF
{
    ...
    public function Header() {
		...
		$this->setLineWidth(1);	
		$this->Text($positionX,$positionY,'INVERSIONES INKA´S PALACE S.A.C.',FALSE,FALSE,TRUE,0,0,'C');
		$this->SetFont('helvetica', 'B', 8);
		
		$this->Text($positionX,$positionY+5,'HOTEL QUADRUM-INN ',FALSE,FALSE,TRUE,0,0,'C');
		$this->SetFont('helvetica', 'B', 7);
		$this->Text($positionX,$positionY+8,'Jr. Bernardo Alcedo 438  LINCE - LIMA - LIMA',FALSE,FALSE,TRUE,0,0,'C');
		
		//$this->setLineWidth(1);	
		$this->SetFont('helvetica', 'B', 8);	   
		//$this->Rect(115,15,80,25,'FD','',array(248, 249, 249 ));
		$this->Text($positionX,$positionY+11,'R.U.C Nº '.$this->RUCEmpresa,FALSE,FALSE,TRUE,0,0,'C');
		$this->Text($positionX,$positionY+15,$this->NomDocumento,FALSE,FALSE,TRUE,0,0,'C');	
		//$this->setLineWidth(1);		
		//$this->Text(-140,35,'Nº ',FALSE,FALSE,TRUE,0,0,'C');
		//$this->SetTextColor(250, 0, 0); 
		$this->Text($positionX,$positionY+20,'Nº '.$this->NumDocumento,FALSE,FALSE,TRUE,0,0,'C');
