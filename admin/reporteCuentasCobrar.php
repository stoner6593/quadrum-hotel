            ...
            <td height="30" colspan="2"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                ...
                <tr>
                  <td height="30" class=" text-success">
                    <h3 style="color:#E1583E;"> <i class="fa fa-book"></i> Reporte Cuentas por cobrar</h3>
              ...
              <tr>
                <td width="1%">
                  ...
                  <form action="reporteCuentasCobrar.php" name="frmlistadocumentos" id="frmlistadocumentos" method="POST">
...
<script type="text/javascript">
  ...
  $(function(){
      ...
      table = $('#example').DataTable( {
        ...
        "aaSorting": [[ 2, 'asc' ]],
        "aoColumns": [          
          { "sTitle": "HABITACIÓN", mData: 'habitacion'},
          { "sTitle": "HUESPED", mData: 'huesped' },
          { "sTitle": "MONTO", mData: 'monto'},
          { "sTitle": "PAGO", mData: 'cobrado'},
          { "sTitle": "COMENTARIOS", mData: 'comentarios'},
         ],
         buttons: [
                    {
                        extend: 'print',
          ...
          "ajax": {
              "method": "POST",
              "url": "include/alquiler/view_reporte_cuentascobrar.php",
              "data": function (d) {
                  return $.extend({}, d, {
  ...
  function formPagar(iddet){
    window.open('form_pagar.php?iddet='+iddet,'modelo','width=400, height=400, scrollbars=yes, location=no, directories=no,resizable=no, top=200,left=300', 'socialPopupWindow');
  }
</script>
