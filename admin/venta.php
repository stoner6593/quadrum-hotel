        ...
        <tbody>
          ...
          <tr>
            <td height="30" colspan="2">
                <form id="form2" name="form2" method="post" action="venta.php?idhabitacion=<?php echo $xidhabitacion.'&idalquiler='.$xidalquiler;?>">
          ...
          <tr>
            <td height="30" colspan="2">
                <form id="form1" name="form1" method="post" action="include/venta/prg_venta-nuevo.php">
              <table width="99%" border="0" cellpadding="0" cellspacing="0">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td height="25" class="textoContenido">
                      <input name="txtformadepago" type="radio" id="radio3" value="1" checked>
                      Efectivo
