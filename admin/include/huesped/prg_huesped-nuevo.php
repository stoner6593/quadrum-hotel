...
//--------------------------------------------------------------
$TblMax = $mysqli->query("select max(idhuesped) from cliente");
...
$xselecsexo = mayuscula($_POST['selecsexo']);
$xestado = 1;
$tipo_documento=$_POST['tipo_documento'];

$sqlbusqueda = $mysqli->query("select idhuesped, documento from cliente where documento = '$xtxtdocumento'");
