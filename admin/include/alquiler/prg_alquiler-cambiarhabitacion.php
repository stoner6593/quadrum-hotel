...
$sqlnumerohabitacion = $mysqli->query("select idhabitacion, numero from hab_venta where idhabitacion = '$xidnuevatxthabitacion'");
...
$consultanuevahabitacion = "update hab_venta set
...
//Actualizar Alquiler
$consultanuevahabitacion = "update al_venta set
