              ...
              <tbody>
                ...
                <tr>
                  <td height="25" align="center">
					...
					<input type="submit" name="enviar" id="enviar" value="Abrir Turno" class="btnrojo" style="width:100%; color:#FFFFFF; padding:10px; font-size:18px; border:0px; cursor:pointer;">
                    <div id="loading" style="display: none;"><img src="imagenesv/loading.GIF"/></div>
                  	</form>
    				<?php } ?>              
                  </td>
                </tr>
