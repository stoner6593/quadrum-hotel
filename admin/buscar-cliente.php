...
function entregar(id,cliente){
    ...
    //window.opener.document.getElementById("div_loading").innerHTML="";

    loading = window.opener.document.getElementById('div_loading');
    if (loading){
...
<body OnLoad="form1.txtdato.focus()" onbeforeunload="return Cerrar()">
