                    ...
                    <table width="95%" border="0" cellpadding="1" cellspacing="1">
                        <tr>
                          <td width="315" height="25" align="left" valign="middle">
                              <h3> <B>CLIENTE:</B> <?php echo $xaFila['7'];?> </h3>
                              <p>
                                  <?php
                          ...
                          <td width="266" height="25" align="right" valign="middle"><span class="textoContenido"><strong>Hab. <?php echo $xtipohabitacion;?> #: </strong></span> <span class="textoContenido" style="font-size:28px;color:#E1583E;"><?php echo $xaFila['3'];?>
