...
$sqlalquiler = $mysqli->query("select
      ...
      where al_venta.codigo_respuesta = 0 ".$concatena." order by  al_venta.fecharegistro DESC
      ");   
...
<link href="basscss.min.css" rel="stylesheet">
    ...
    <script language="javascript">
        function showFormSendEmail(idalquiler){
            //$( "#div_loading" ).remove();
            window.open("enviar_fe_cliente.php?idalquiler="+idalquiler,"modelo","width=600, height=450, top=200,left=300, scrollbars=yes" );
        }
    </script>
</head>
<body>
            ...
            <td height="30" colspan="2"><table width="100%" border="0" cellpadding="1" cellspacing="1">
              ...
              <tr>
                <td width="1%">
                  ...
                  <form action="listadosunat.php" name="frmlistadocumentos" id="frmlistadocumentos" method="POST">
                    Fecha Inicio:<input name="finicio" value="<?php echo date("d/m/Y");?>" type="text" class="form-control" id="datepicker1" placeholder=" dd/mm/YYYY"  >  Fecha Inicio:<input name="ffin" type="text" value="<?php echo date("d/m/Y");?>" class="form-control" id="datepicker2" placeholder=" dd/mm/YYYY" >
                        ...
                        <tbody>
                          ...
                          ?>
                            <tr>
                              ...
                              <td><button type="button" class="btn btn-primary mb1 bg-orange tooltip" onclick="showFormSendEmail(<?php echo $xhFila['0'];?>);"
                                            tooltip="email" id="btnemail" name="btnemail" style="border:0px; cursor:pointer;"> <i class="fas fa-envelope" style="font-size: 14px;"></i></button></td>
                             </tr>
                           <?php
                              }
                              $sqlalquiler->free();
...
<script type="text/javascript">
  ...
  $(function(){
      ...
      $('#example tbody ').on('click','#cdr',function(e){

          e.preventDefault();
          
          var cod=$(this).attr('data-id-cdr'); 
          swal("Buscando Archivo..! Por favor espere...", {
            buttons: false,
            closeOnEsc: false,
            timer: 2000,
      ...
      table = $('#example').DataTable( {
        ...
        "aoColumns": [
          ...
          { "sTitle": "Email","sWidth": "70px" , "sClass": "center"},
          ],
         buttons: [
                    {
                        extend: 'print',
