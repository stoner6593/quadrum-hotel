    ...
    <form name="form1" method="post" action="PHPMailer/sendEmail.php?idalquiler=<?php echo $idalquiler;?>">
      ...
      <table width="100%" border="0" cellpadding="1" cellspacing="1">
        ...
        <tr>
            ...
            <td width="33%" class="textoContenidoMenor">
                <input name="txtcorreocopia" type="text" class="textbox" id="txtcorreocopia">
            </td>
        </tr>
          <tr>
          ...
          <tr>
              ...
              <td width="33%" class="textoContenidoMenor">
                  <textarea name="txtcuerpo" id="txtcuerpo" rows="6" cols="60">Buenas Estimado <?php echo $nombreCliente;?>:
