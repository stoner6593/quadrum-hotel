...
<head>
<meta charset="utf-8">
<title>Reporte por tipo de reserva</title>
            ...
            <td height="30" colspan="2"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                ...
                <tr>
                  <td height="30" class=" text-success">
                    <h3 style="color:#E1583E;"> <i class="fa fa-list"></i> Reporte por tipo de reserva</h3>
              ...
              <tr>
                <td width="1%">
                    <hr/>
                  <form action="reporteReservas.php" name="frmlistadocumentos" id="frmlistadocumentos" method="POST">
