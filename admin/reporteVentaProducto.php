            ...
            <td height="30" colspan="2"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                ...
                <tr>
                  <td height="30" class=" text-success">
                    <h3 style="color:#E1583E;"> <i class="fa fa-book"></i> Reporte venta producto</h3>
              ...
              <tr>
                <td width="1%">
                  ...
                  <form action="reporteVentaProducto.php" name="frmlistadocumentos" id="frmlistadocumentos" method="POST">
...
<script type="text/javascript">
  ...
  $(function(){
      ...
      table = $('#example').DataTable( {
        ...
        "aaSorting": [[ 2, 'asc' ]],
        "aoColumns": [          
          { "sTitle": "NÚMERO", mData: 'numero'},
          { "sTitle": "CLIENTE", mData: 'cliente' },
		  { "sTitle": "PRODUCTO/SERVICIO", mData: 'nombre' },
         ...
         buttons: [
          ...
          "ajax": {
              "method": "POST",
              "url": "include/alquiler/view_reporte_ventaproducto.php",
              "data": function (d) {
                  return $.extend({}, d, {
