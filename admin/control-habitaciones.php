  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="810" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        $sqlalqdet = $mysqli->query("select 
          idalquilerdetalle, 
          tiporeserva 
          from al_venta_detalle 
          where idalquiler = '$xidalquiler' 
            and tiporeserva >= 1 and tiporeserva <= 7");

        $adetFila = $sqlalqdet->fetch_row();
    ...
    <tr>
      <td height="25" colspan="3"><table width="555" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="10" height="10" align="left" valign="middle" bgcolor="#635163">&nbsp;</td>
          <td width="146" height="10" align="left" valign="middle">&nbsp;<span class="textoContenidoMenor">Crédito</span></td>
        </tr>
        <tr>
