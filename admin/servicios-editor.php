    ...
    <tr>
      ...
      <td width="1125" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="203" align="right"> <button type="button" onclick="window.location.href='servicios.php';" class="btngris" style="border:0px; cursor:pointer;"> <i class="fa fa-arrow-left"></i> Volver </button> </td>
          </tr>
          <tr>
            <td height="30" colspan="2"><table width="100%" border="0" cellpadding="1" cellspacing="1">
                ...
                <tr>
                  <td height="30"><form id="form1" name="form1" method="post" action="<?php if($xestado=='modifica'){echo 'include/servicios/prg_servicios-modifica.php';}else{echo 'include/servicios/prg-servicios-nuevo.php';}?>">
                    <table width="100%" border="0" cellpadding="1" cellspacing="1">
                      <tbody>
                        <tr>
                          <td width="224" height="30" class="textoContenido">Descripci&oacute;n
                        ...
                        <tr>                         
                          <td height="30"><input name="txtprecioventa" type="text" class="textbox" value="<?php echo $xpFila['2'];?>" style="text-align:right;"></td>
