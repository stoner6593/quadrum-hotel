...
$sqlhabitacionestado = $mysqli->query("select 
	idestado,
	estado
	from hab_estado order by idestado asc");
...
$sqlhabitacion = $mysqli->query("select 
    ...
    hab_venta.precio12,
    hab_venta.precio12vs,
    preciobooking,
    precioreservaweb
	
	from hab_venta 
	where hab_venta.idhabitacion = '$xidprimario'");

$xhFila = $sqlhabitacion->fetch_row();

$idhabitacion = $xhFila['0'];
      ...
      <td width="1125" valign="top"><table width="900" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="30" colspan="2"><table width="905" border="0" cellpadding="1" cellspacing="1">
                ...
                <tr>
                  <td height="30">
                      <form id="form1" name="form1" method="post" action="<?php if($xestado=="modifica"){echo 'include/habitacion/prg_habitacion-modifica.php';}else{echo 'include/habitacion/prg_habitacion-nuevo.php';}?>">
                    ...
                    <table width="900" border="0" cellpadding="1" cellspacing="1">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="225" height="25"><span class="textoContenidoMenor">Precio 6H (Dom-Jue)</span></td>
                          <td width="211" height="25"><span class="textoContenidoMenor">Precio Diario (Vie-Sab)</span></td>
                          <td width="249" height="25"><span class="textoContenidoMenor">Precio 6H (Vie-Sab)</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td width="202" height="25"><span class="textoContenidoMenor">Precio por Persona Adicional</span></td>
                          <td width="225" height="25"><span class="textoContenidoMenor">Precio por Hora Adicional</span></td>
                        ...
                        <tr>
                            <td width="202" height="25"><span class="textoContenidoMenor">Precio Booking</span></td>
                            <td width="225" height="25"><span class="textoContenidoMenor">Precio Expedia</span></td>
                            <td height="25" valign="middle">&nbsp;</td>
                            <td height="25" valign="middle">&nbsp;</td>
                            <td height="25" valign="middle">&nbsp;</td>
                            <td height="25" valign="middle">&nbsp;</td>
                        ...
                        <tr>
                            <td height="25" valign="top"><input name="txtpreciobooking" type="text" class="textbox" id="txtpreciobooking" style="width:85%; text-align:right;" onFocus = "txtpreciobooking.value = EliminarComa(this.value)" onBlur="document.form1.txtpreciobooking.value = formatCurrency(txtpreciobooking.value);" value="<?php echo number_format($xhFila['17'],2);?>"></td>
                            <td height="25" valign="top"><input name="txtprecioreservaweb" type="text" class="textbox" id="txtprecioreservaweb" style="width:85%; text-align:right;" onFocus = "txtprecioreservaweb.value = EliminarComa(this.value)" onBlur="document.form1.txtprecioreservaweb.value = formatCurrency(txtprecioreservaweb.value);" value="<?php echo number_format($xhFila['18'],2);?>"></td>
                            <td height="25" valign="middle">&nbsp;</td>
                            <td height="25" valign="middle">&nbsp;</td>
                            <td height="25" valign="middle">&nbsp;</td>
                            <td height="25" valign="middle">&nbsp;</td>
                        ...
                        <tr>
                            <td width="202" height="25"><span class="textoContenidoMenor">Características</span></td>
                            <td height="25" valign="middle">&nbsp;</td>
                            <td height="25" valign="middle">&nbsp;</td>
                            <td height="25" valign="middle">&nbsp;</td>
                            <td height="25" valign="middle">&nbsp;</td>
                        ...
                        <tr>
                          <td height="30" colspan="2">
                            <?php if($xestado=="modifica"){?>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <button type="submit" onclick="window.location.href='include/habitacion/prg_habitacion-libera.php?$idhabitacion=<?php echo $idhabitacion;?>'; return false"
                                        class="btnrojo" style="border:0px; cursor:pointer;background: #00A230">
                                    <i class="fa fa-arrow-right"></i> Liberar </button>
