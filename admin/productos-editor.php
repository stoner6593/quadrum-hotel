                  ...
                  <td height="30"><form id="form1" name="form1" method="post" action="<?php if($xestado=='modifica'){echo 'include/producto/prg_producto-modifica.php';}else{echo 'include/producto/prg_producto-nuevo.php';}?>">
                    <table width="100%" border="0" cellpadding="1" cellspacing="1">
                      <tbody>
                        ...
                        <tr>
                          <td height="30"><input name="txtcantidad" type="text" class="textbox"  onKeyPress="return soloNumero(event)" value="<?php echo $xpFila['3'];?>" maxlength="5" <?php if($_SESSION['xyztipo']!=1 && $_SESSION['xyztipo']!=4){echo 'readonly';}?> ></td>
                          <td height="30"><input name="txtprecioventa" type="text" class="textbox" value="<?php echo $xpFila['6'];?>" style="text-align:right;"></td>
                          <td height="30"><input name="txtprecioventapersonal" type="text" class="textbox" value="<?php echo $xpFila['9'] =='' ? 0 : $xpFila['9']  ;?>" style="text-align:right;"></td>
