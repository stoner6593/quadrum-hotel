...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'hotelesperu2020@gmail.com';                 // Usuario SMTP
    $mail->Password = 'odihkbnqhvjiktrd';                           // Password SMTP
    $mail->SMTPSecure = 'tls';                            // Activar seguridad TLS
    $mail->Port = 587;                                    // Puerto SMTP
 
    $mail->setFrom('sistemas@corporacionchac.com');		// Mail del remitente
    $mail->addAddress($txtCorreo);     // Mail del destinatario
    $mail->AddReplyTo('sistemas@corporacionchac.com', 'Information'); //Mail informacion responder
