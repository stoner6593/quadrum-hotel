...
$sqlalquiler = $mysqli->query("select
	...
	inner join usuario b on b.user_id = al_venta.idusuario
    ...
    $nombreUsuario = $xaFila[13];
    $dniUsuario = $xaFila[14];
...
$sqldetalle = $mysqli->query("select
	...
	idusuario,
	CASE
		WHEN tiporeserva = 1 THEN 'Booking'
        WHEN tiporeserva = 2 THEN 'Reserva Web'
        WHEN tiporeserva = 3 THEN 'Expedia'
        WHEN tiporeserva = 4 THEN 'Facebook'
        WHEN tiporeserva = 5 THEN 'Crédito'
        WHEN tiporeserva = 6 THEN 'Depósito'
        WHEN tiporeserva = 7 THEN 'Pago en linea'
        ELSE 'OTRO'
    END	
...
<table width="260" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="20" align="center"><span class="textoContenido">Recepción: <?php echo $nombreUsuario;?></span></td>
    </tr>
    <tr>
      <td height="20">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <span class="textoContenido">
		...
		echo tipoAlquiler($tmpFila['2']).' '.$tmpFila['23'].' ('.$tmpFila['19'].')';
