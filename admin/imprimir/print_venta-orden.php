...
<table width="260" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      <td height="20" colspan="2" align="center"><span class="textoContenido"><strong><?php echo $razonSocial; ?></strong></span></td>
    </tr>
    <tr>
      <td height="20" colspan="2" align="center"><span class="textoContenido"><?php echo $direccionFiscal; ?></span></td>
    </tr>
    <tr>
      <td height="20" colspan="2" align="center"><span class="textoContenido"><?php echo $direccionFiscalDistrito; ?> - <?php echo $direccionFiscalProvincia; ?> / <?php echo $telefonos; ?></span></td>
    </tr>
    <tr>
