...
$sqlhab = $mysqli->query("select idhabitacion, idalquiler from hab_venta order by idalquiler asc");
$xocupados = 0;
$xlibres = 0;
...
$sqlnumeroalquiler = $mysqli->query("select idalquiler, idturno from al_venta where idturno = '$xidturno'");
...
<table width="260" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    <tr>
      <td width="260" height="22" align="center"><span class="textoContenido"><strong><?php echo $razonSocial; ?> </strong></span></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22" align="center"> <span class="textoContenido">Recepción:<strong> <?php echo $dniUsuario." - ".$nombreUsuario;?></strong></span></td>
    </tr>
    <tr>
