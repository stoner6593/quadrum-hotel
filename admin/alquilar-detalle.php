...
$documento = explode('-',$xaFila['17']);
$serie_doc = isset($documento[0]) ? $documento[0] : '';
$numeracion_doc =isset($documento[1]) ? $documento[1] : '';
...
$sqlventa = $mysqli->query("select
	...
	where venta.idalquiler = '$xidalquiler' 	order by ventadetalle.idventadetalle asc"); //and ventadetalle.procesado='0'
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td width="460" height="30">
							<h3 style="color:#E1583E;"> <i class="fa fa-users"></i> Habitación Alquilada (Detalle)</h3>
						</td>
					...
					<tr>
						<td height="30" colspan="3">
							<table width="100%" border="0" cellpadding="1" cellspacing="1">
								...
								<tr>
									<td width="911" height="30">
										<div class="lineahorizontal" style="background:#BFBFBF;">
											...
											<table width="95%" border="0" cellpadding="1" cellspacing="1">
												<tr>
													<td width="400" height="25" align="left" valign="middle">
														...
														<h3>
															...
															<?php if ($xaFila['14'] !== "") { ?>
																<input type="radio" name="sel_doc" value="1" <?php if ($xaFila['16'] == "1") { ?> checked <?php } ?> onclick="cambiaTipoDoc(this.value);" />
															<?php } ?>
														</h3>
														...
														<h3>
															...
															<?php if ($xaFila['14'] !== "") { ?>
																<input type="radio" name="sel_doc" value="6" <?php if ($xaFila['16'] == "6") { ?> checked <?php } ?> onclick="cambiaTipoDoc(this.value);" />
															<?php } ?>
														</h3>
														</p>
														<p>
														...
														<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#F0F0F0">
															<tr class="textoContenidoMenor">
																<td width="5%" height="25" bgcolor="#F4F4F4">
																	<div align="center"><strong>#</strong></div>
																</td>
																<td width="5%" height="25" bgcolor="#F4F4F4">
																	<div align="center"><strong>Tipo</strong></div>
																</td>
																<td width="38%" height="25" align="left" valign="middle" bgcolor="#F4F4F4">
																	<div align="left">Nombres y Apellidos</div>
																</td>
																<td width="20%" align="left" valign="middle" bgcolor="#F4F4F4">
																	<div align="left">DNI </div>
																</td>
																<td width="11%" align="left" valign="middle" bgcolor="#F4F4F4">
																	<div align="left">SEXO </div>
																</td>
																<td width="15%" height="25" align="left" valign="middle" bgcolor="#F4F4F4">
															...
															?>
																<tr class="textoContenidoMenor">
																	<td height="25" bgcolor="#FFFFFF" class="textoContenidoNegro">
																		<div align="center"><? echo $suma; ?></div>
																	</td>
												...
												<tr>
													<td height="25" colspan="3" valign="top">
														<div class="lineahorizontal" style="background:#BFBFBF;"></div>
													</td>
												</tr>
												<tr>
														...
														<table width="100%" border="0" cellspacing="1" cellpadding="1">
															...
															<tr>
																<td height="25" colspan="7">
																	<div class="lineahorizontal" style="background:#00A230;"></div>
																</td>
															</tr>
															<?php
															...
															while ($tmpFila = $sqldetalle->fetch_row()) {
																...
																if ($tmpFila[23] == 0) : $cuentaAlquiler += 1;
																endif;
																$num++; ?>
																<tr class="textoContenidoMenor">
								...
								<tr>
									<td height="52" colspan="3" valign="bottom">
										...
										<span class="textoContenido" style="font-weight: bold"> Renovar / Adicionar </span>
									</td>
								</tr>
								<tr>
										...
										<div class="div1" style="display:display;">
											<form id="frmrenovar" name="frmrenovar" method="post">
												<table width="98%" border="0" cellspacing="1" cellpadding="1">
													<tr>
														<td width="456" height="30" class="textoContenido">
															<table width="100%" border="0" cellspacing="1" cellpadding="1">
																<tr>
																	...
																	<td width="71" height="30" class="textoContenido">S/ <?php echo $preciohora; ?>
																		<input name="txtprecioporhora" type="hidden" id="txtprecioporhora" value="<?php echo $preciohora; ?>">
																	</td>
													...
													<tr>
														<td height="30" class="textoContenido">
															<table width="100%" border="0" cellspacing="1" cellpadding="1">
																<tr>
																	<td width="134" height="30" class="textoContenido">Renovar Por Día</td>
																	<td width="73" class="textoContenido">
																		<!--<S/--> <?php //echo $preciodiario;
																					?>
																		<input name="txtpreciopordia" type="text" class="textbox" id="txtpreciopordia" value="<?php echo $preciodiario; ?> ">
																	</td>
										...
										<div class="div2" style="display:display;">
											<form id="frmagregar" name="frmagregar" method="post">
												<table width="98%" border="0" cellspacing="1" cellpadding="1">
															...
															<table width="100%" border="0" cellspacing="1" cellpadding="1">
																<tr>
																	...
																	<td width="71" height="30" class="textoContenido">S/ <?php echo $xpreciohuespedadicional; ?>
																		<input name="txtprecioocupanteadicional" type="hidden" id="txtprecioocupanteadicional" value="<?php echo $xpreciohuespedadicional; ?>">
																	</td>
															...
															<table width="100%" border="0" cellspacing="1" cellpadding="1">
																<tr>
																	...
																	<td width="73" class="textoContenido">S/ <?php echo $xpreciohoraadicional; ?>
																		<input name="txtpreciohoraadicional" type="hidden" id="txtpreciohoraadicional" value="<?php echo $xpreciohoraadicional; ?>">
																	</td>
													...
													<tr>
														<td height="30" class="textoContenido">
															<div class="lineahorizontal" style="background:#FFAF03;"> </div>
														</td>
													</tr>
												</table>
											</form>
									...
									<td height="30">
										<table width="100%" border="0" cellpadding="1" cellspacing="1">
											<tr>
												...
												<td width="107" align="right" bgcolor="#FFFFFF"><a href="venta.php?idhabitacion=<?php echo $xidhabitacion . '&idalquiler=' . $xidalquiler; ?>" <?php /*echo   $cuentaProductos.'-'.$cuentaAlquiler;*/ if ($xaFila[10] == '0') {
																																																echo 'style="display:  "';
																																															} ?>class="btnrojo"> <i class="fa fa-plus-square"></i></a> &nbsp;</td>
											</tr>
										</table>
										<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#E0E0E0">
											...
											<?php
												$_SESSION['xcliente'] = "";
												$_SESSION['xidcliente'] = "";
												if ($vFila[8] == 0) :  $cuentaProductos += 1;
												endif;
											...
											<tbody>
												<tr>
													<td width="395" height="25">
														<form id="frmcomentario" name="frmcomentario" method="post" action="include/alquiler/prg_anotaciones.php?idhabitacion=<?php echo $xidhabitacion . '&idalquiler=' . $xidalquiler; ?>">
											...
											<tbody>
												<tr class="textoContenido">
													...
													<td width="30%" height="24">
														...
														<input name="txtFechaSalidaHuesped" type="text" id="txtFechaDiaAdicional" class="textbox" style="width:45%;" placeholder="Seleccione Fecha/Hora">
													</td>
												</tr>
											</tbody>
										</table>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="1">
											<tbody>
												<tr>
													...
													<td><strong <?php if (isset($xaFila[10]) && $cuentaAlquiler == 0 && $cuentaProductos == 0) {
																	echo 'style="display: none"';
																} ?>>Tipo de Documento:</strong></td>
													<td>

														<select name="serie" id="series" class="select" <?php if (isset($xaFila[10]) && $cuentaAlquiler == 0 && $cuentaProductos == 0) {
																											echo 'style="display: none; "';
																										} ?>>
															<option value=""></option>
															<?php while ($tmpSeries = $serie->fetch_row()) {
																$num++; ?>
													...
													<td>
														...
														<button id="ProcesaEnvio" <?php if (isset($xaFila[10]) && $cuentaAlquiler == 0 && $cuentaProductos == 0) {
																						echo 'style="display: none;"';
																					} ?> class="btnrojo"><i class="fa fa-arrow-up" id="liAnula"></i> Enviar Sunat</button>
													</td>
													<td>

														<button id="consultaCDR" <?php if (!isset($serie_doc) && !isset($numeracion_doc) ) {
																						echo 'style="display: none;"';
																					} ?> class="btnrojo"><i class="fa fa-search" id="liAnula"></i> Consulta CDR</button>
													</td>
...
<script type="text/javascript">
 ...
 /*<?php echo APP_SUNAT_USER; ?> */
		$("#consultaCDR").on('click',function(e){
			e.preventDefault();

			$.ajax({
				url: 'consulta_cdr.php',
				type: 'post',
				data: {
					'rucSol':  <?php echo APP_EMISOR_RUC; ?>,
					'userSol': 'HOTELES1',
					'passSol': '<?php echo APP_SUNAT_PASS; ?>',
					'ruc': <?php echo APP_EMISOR_RUC; ?>,
					'tipo': '01',
					'serie': '<?php print_r($serie_doc); ?>',
					'numero':  '<?php print_r($numeracion_doc); ?>',
					'cdr':  '',
				},
				beforeSend: function() {
				...
				success: function(data) {
					...
					if (typeof data.success != "undefined") {
						if (data.success) {
							swal("Documento encontrado!" , data.message, "success");
				...
				.then((willDelete) => {
					...
					if (willDelete) {
						...
						$.ajax({
							...
							type: 'post',
							data: {
								'idalquiler': <?php echo $xidalquiler; ?>,
								'tipo_documento': $("#series").val(),
								'tipo_servicio': 'AL'
							},
							//dataType:'json',
							beforeSend: function() {
